                  ...
                  <div className="flex items-start space-x-2 pt-2">
                    ...
                    <div className="grid gap-1.5 leading-none">
                      ...
                      <p className="text-xs text-muted-foreground">
                        En soumettant ce formulaire, j'accepte que mes données soient traitées conformément à la politique de confidentialité pour recevoir une réponse à ma demande. Mes données ne seront pas utilisées à des fins commerciales et seront conservées uniquement le temps nécessaire au traitement de ma demande.
                      </p>
                    </div>
                  </div>
            ...
            <Card className="h-full">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="pt-6 border-t text-center">
                  <h3 className="text-xl font-semibold mb-6">Retrouvez-moi sur les réseaux</h3>
